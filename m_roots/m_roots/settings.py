"""
Django settings for m_roots project.
...
SECRET_KEY = 'django-insecure-!x!h@2!wx)m=jt(cvdqtkz$@rpimertn*-i(01dte-a=8_8f0p'
...
WSGI_APPLICATION = 'm_roots.wsgi.application'
